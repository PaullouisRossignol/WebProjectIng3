...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 02 mai 2019 à 18:19
...
('aerg', 'Visa', 'aztrh', '2019-05-22', 'ztrh', 'zrth', ' ', 'sth', 'aerg', 'zrt', 'zth');
...
('pl@aeofiugn', 'ferg', 'sqdfg', 'aerg', 'res/indeqdgqdhx.jpg');
...
('Tour eiffel', 252527, 2147483647, 'un peu vieille mais fait le taff.', 3, 1, 0, NULL, NULL, NULL, 'pl@aeofiugn', 'res/office_du_tourisme_de_paris_tour_eiffel_2.jpg', 'res/pub_chauss.mp4');
...
--
ALTER TABLE `products`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=252528;
COMMIT;
