...
<div class="container">
  ...
  //si le BDD existe, faire le traitement
      ...
      echo "<div id='rightcolumn'>Pic_loc:" . $data['Pic_loc'] .'<br>';
      echo "<a href='ProductPage.php?Id=".$data['ID']."'> " . $data['Name'] . '</a><br>';
      echo "ID:" . $data['ID'] . '<br>';
      echo "Price: " . $data['Price'] . '<br>';
      echo "Desc: " . $data['Descr'] . '<br>';
      ...
      echo "Vid_link: " . $data['Vid_link'] .'<br><br></div>';
      }//end while
